...
function savePinboard() {
    ...
    var obj = JSON.parse(pbSaveArray);
    ...
    if ( jQuery.isEmptyObject(pbObjsJSON['objects']) ) {
        pbObjsJSON['objects'].push({"id":id,"objects":pbObjs});
    }
    ...
    pbSaveArray = JSON.stringify(obj,null,4);					// Das JSON-Objekt wird wieder in Text umgewandelt und automatisch prettified
    log(pbSaveArray,"d");
